    ...
    <div>
        ...
        <el-card>
            ...
            <template slot="opt" slot-scope="scope">
              ...
              <el-button type="warning" icon="el-icon-delete" size="mini" @click="removeCateDialog(scope.row.cat_id)">删除</el-button>
            </template>
            </tree-table>
            <!-- 分页区 -->
            <el-pagination
        ...
        <el-dialog
          ...
          width="30%">
          <el-form :model="editCate" ref="editCateRef" label-width="70px">
            <el-form-item label="分类名称" prop="cat_name">
